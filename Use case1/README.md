...
## Directory structure
Each folder under [Use case1/src](./src) contains the CKAN metadata statement files (in JSON format), the corresponding YARRRML mapping rules, the intermediary RML file and the generated output in Turtle (TTL) format. 
...
```
Then, execute the generated RML mapping with [RMLMapper](https://drive.google.com/file/d/1wOW44Nlq9NA_ie_twcSx6sEzHPKuc6qs/view?usp=drive_link):
```
java -jar rmlmapper-17.0.0-r449-all.jar -m out.rml.ttl -o out.ttl
```
